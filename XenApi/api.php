    ...
    public function processRequest() {
        ...
        case 'createprofilepost':
            ...
            case 'logout':
                /**
                 * Logout from Xenforo
                 * Based on : https://github.com/intelliants/subrion-plugin-xenforo/blob/master/includes/classes/ia.common.xenforo.php#L154-L172
                 */
                ...
                {
                    $getAdminSession = new XenForo_Session(['admin' => true]);
                    $getAdminSession->start();
                    if ($getAdminSession->get('user_id') == XenForo_Visitor::getUserId())
                    {
                        $getAdminSession->delete();
                    }
                }
                ...
                $this->sendResponse(['success' => 'xf_session has been removed, user has been logged out !']);
            case 'register':
                /**
                * Registers a user.
                */
